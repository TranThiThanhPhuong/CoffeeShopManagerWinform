...
namespace GUI
{
    public partial class Form_QLy_TaiKhoan : Form
    {
        ...
        string strCon = @"Data Source=HUMITO\PHUONGSUGA;Initial Catalog=QLY_Pos;Persist Security Info=True;User ID=sa;Password=***********;Encrypt=True;Trust Server Certificate=True";
