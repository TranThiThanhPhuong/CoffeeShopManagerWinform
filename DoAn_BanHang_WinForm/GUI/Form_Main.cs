...
namespace GUI
{
    public partial class Form_Main : Form
    {
        ...
        string strCon = @"Data Source=HUMITO\PHUONGSUGA;Initial Catalog=QLY_Pos;Persist Security Info=True;User ID=sa;Password=28926333plTT@;Encrypt=False;Trust Server Certificate=True";
        void load()
        {
